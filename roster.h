    ...
    // Create a student object for each student in the data table and populate classRosterArray.
        ...
        // b.  Add each student object to classRosterArray
            //FUNCTIONS IN THE CLASS: 
                //  in the provided format: A1 [tab] First Name: John [tab] Last Name: Smith [tab] Age: 20 [tab]daysInCourse: {35, 40, 55} Degree Program: Security. The printAll() function should loop through all the students in classRosterArray and call the print() function for each student.
